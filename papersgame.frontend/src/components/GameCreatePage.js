                ...
                <Col sm={6}>
                    <Form>
                        ...
                        <Form.Group controlId="formPlayerCount">
                            ...
                            <Form.Control name="playerCount" type="number" min="2" max="6" placeholder=""
                                value={playerCount} onChange={(event) => setplayerCount(event.target.valueAsNumber)} />
                        </Form.Group>

                        <Button variant="primary" className="mt-1" onClick={() => props.createGame(playerName, gameName, playerCount)}>
                            Start game
                        </Button>
                    </Form>
                </Col>
